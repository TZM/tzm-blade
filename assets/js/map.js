(function mapClient() {
    ...
    this.drawIcons = function() {
        ...
        var iconHolder = self.svg.append("g")
            ...
            .attr("transform", "scale(" + s * 1.45 + ")translate(" + width * 0.96 + "," + -60 + ")")

        iconHolder.append("svg:path")
            .attr("class", "group-icon")
            .attr("d", groupIcon)
            .attr("transform", "scale(" + s + ")translate(" + 0 + "," + 120 + ")")
        ...
        iconHolder.append("svg:path")
            ...
            .attr("d", projectsIcon)
            .attr("transform", "scale(" + s + ")translate(" + 125 + "," + 110 + ")")
            .on("mouseover", function(d) {
                d3.select(this)
                .style("fill", "orange")
                .append("svg:title")
        ...
        iconHolder.append("svg:path")
            ...
            .attr("transform", "scale(" + s + ")translate(" + -65 + "," + 110 + ")")
            .on("mouseover", function(d) {
                d3.select(this)
                .style("fill", "orange")
                .append("svg:title")
