...
g = iconGroup.append("g").attr("class", "group-icon").attr("name", "groups")
addRect(g)
g.append("svg:path").attr("d", mapHelper.groupIcon)

g = iconGroup.append("g").attr("class", "projects-icons").attr("transform", "translate(110)").attr("name", "projects")
addRect(g)
g.append("svg:path").attr("d", mapHelper.projectsIcon)

g = iconGroup.append("g").attr("class", "skill-share-icon").attr("transform", "translate(220)").attr("name", "share your skills with tzm")
addRect(g)
